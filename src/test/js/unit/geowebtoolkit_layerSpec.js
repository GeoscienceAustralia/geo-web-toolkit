...
//JSLint Initialisers
describe(
    'geowebtoolkit geo-map-layer controller interface tests',
    function () {
        "use strict";
        ...
        beforeEach(inject(function (_$compile_, _$rootScope_, _$timeout_) {
            ...
            element = angular
                .element('<geo-map map-element-id="geoMap" datum-projection="EPSG:102100" display-projection="EPSG:4326">' + '<geo-map-layer layer-name="Australian Landsat Mosaic"'
