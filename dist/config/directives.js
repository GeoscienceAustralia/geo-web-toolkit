 ...
 <example module="simpleMapWithConfig">
     ...
     <file name="ourConfigFile.json">
         ...
         "layerMaps": [
         {
			...
			{"description": "REST","url": "http://services.ga.gov.au/gis/rest/services/Topographic_Base_Map_WM/MapServer"},
			{"description": "WMS Capabilities","url": "http://services.ga.gov.au/gis/rest/services/Topographic_Base_Map/MapServer/WMSServer?request=GetCapabilities&service=WMS"},
			{"description": "ArcMap Layerfile","url": "http: MapServer?f=lyr&v=9.3"}
			],
            "opacity":1.0,
            "layerTimeout": 5000
        }
