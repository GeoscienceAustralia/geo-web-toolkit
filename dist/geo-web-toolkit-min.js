...
angular.module('geowebtoolkit.ui.templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/main/js/ui/components/deprecated/layers-dialog.html',
    ...
    "        <geo-layer-control map-controller=\"mapController\" layer-data=\"layer\"></geo-layer-control>\n" +
    "    </div>\n" +
    "</div>\n"
  );
  ...
  $templateCache.put('src/main/js/ui/components/layer-control/layer-control.html',
    "<label for=\"{{elementId}}\" class=\"checkbox geoLayerControlLabel\">\n" +
    ...
    "</label>\n" +
    "<div class=\"geoLayerControlTransclude\" ng-transclude></div>\n" +
    "<div ng-show=\"layerData.visibility\" class=\"geoLayerControlSliderContainer\">\n" +
  ...
  $templateCache.put('src/main/js/ui/components/measure-toggle/measure-toggle.html',
    "<button type=\"button\" ng-click=\"handleToggle()\" class=\"geoUiToggleOff\">\n" +
